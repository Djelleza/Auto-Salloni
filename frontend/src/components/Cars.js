...
import car1 from '../assets/carPhoto/kerri1.png'; 

const Cars = () => {
  const carsData = [
    { id: 1, image: car1, year: 2020, mileage: '50,000 km', type: 'Used' },
    { id: 2, image: car1, year: 2019, mileage: '40,000 km', type: 'Used' },
    { id: 3, image: car1, year: 2021, mileage: '30,000 km', type: 'New' },
    { id: 4, image: car1, year: 2022, mileage: '20,000 km', type: 'New' },
    { id: 5, image: car1, year: 2023, mileage: '10,000 km', type: 'New' },
    { id: 6, image: car1, year: 2020, mileage: '60,000 km', type: 'Used' },
  ];
    ...
    <div className="bg-green-50 text-black">
      ...
      <nav className="bg-black p-8 flex justify-around items-center relative z-10 rounded-b-lg max-w-5xl mx-auto px-25">
        <ul className="flex space-x-8">
          {['Brand', 'Model', 'Fuel Type', 'Transmission', 'Color'].map((item) => (
